...
\label{eq:EC/30/2023/5}&\implies 0\\
\text{and, }
\label{eq:EC/30/2023/6}S_X(-\omega)&=S_X(\omega)\\
\int{R_X(\tau)e^{j\omega\tau}d\tau}&= \int{R_X(\tau)e^{-j\omega\tau}d\tau}
\end{align}
So, the properties of $S_X$ are:
\begin{enumerate}
\item \label{eq:EC/30/2023/7} $\text{Im}S_X(\omega)=0$
\item \label{eq:EC/30/2023/8}$S_X(-\omega)= S_X(\omega)$
\end{enumerate}
Now,
\begin{enumerate}
\item 
...
So, $S_X$ is valid.\\
\item
Using \eqref{eq:EC/30/2023/7} \& \eqref{eq:EC/30/2023/8}
\begin{align}
...
\end{enumerate} 
$\therefore$ Option \eqref{eq:EC/30/2023/1} and \eqref{eq:EC/30/2023/2} are correct.