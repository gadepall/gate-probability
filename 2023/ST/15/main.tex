...
C and Python codes are given below :
  \lstinputlisting[language=C]{/2023/ST/15/codes/rand.c}
  \lstinputlisting[language=Python]{/2023/ST/15/codes/rand.py}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\columnwidth]{/2023/ST/15/figs/figure1.png}  % Replace 'image_filename' with your image file name
