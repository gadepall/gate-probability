...
\begin{table}[h]
	\input{/home/aman123/GATE-EC(2022)/XL/64/tables/table3.tex}
	\caption{Table3: $R$=1,$r$=0}
	\label{tab:XL/64/table1}
\end{table}\\
On crossing between $00$ and $11$ we get:
\begin{table}[h]
	\input{/home/aman123/GATE-EC(2022)/XL/64/tables/table1.tex}
...
\begin{table}[h]
	\input{/home/aman123/GATE-EC(2022)/XL/64/tables/table2.tex}
