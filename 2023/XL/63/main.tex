...
\begin{table}[h]
	\centering
	\input{2023/XL/63/tables/t5.tex}
	\caption{Gene Representation.}
        \label{tab:Gate XL 63/2023/5}
\end{table}
\\ For the parent genes:
\begin{table}[h]
	\centering
	\input{2023/XL/63/tables/t1.tex}
...
\begin{figure}[h]
	\centering	
	\includegraphics[width=\columnwidth]{2023/XL/63/figs/graph.png}
