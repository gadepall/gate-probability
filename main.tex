...
\chapter{Axioms}
\input{GATE/axioms.tex}
\chapter{Distributions}
\input{GATE/dist.tex}
\chapter{Conditional Probability}
\input{GATE/cond.tex}
\chapter{Random Variable}
\input{GATE/random_variable.tex}
\chapter{Moments}
\input{GATE/moments.tex}
...
\input{GATE/rp.tex}
\chapter{Convergence}
\input{GATE/convergence.tex}
\chapter{Information Theory}
\input{GATE/Inf.tex}
\chapter{Markov chain}
\input{GATE/markov.tex}
\chapter{Estimation}
\input{GATE/estimation.tex}
\chapter{Multivariate Gaussian}
\input{GATE/Multivariate.tex}
%\include{ch02} 
\backmatter
\appendix
\latexprintindex
